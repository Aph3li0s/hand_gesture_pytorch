...
def combined_lst(landmarks_lst1, num, landmarks_lst2=None):
    ...
    return final_lst
num_class_lst = [500, 500, 500, 500, 500]
        ...
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks and results.multi_handedness:
                ...
                for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                    ...
                    pre_processed_landmark_list = u.pre_process_landmark(landmark_list)

                    if handedness.classification[0].label == "Left":
                        right.extend(pre_processed_landmark_list)
                    elif handedness.classification[0].label == "Right":
                        left.extend(pre_processed_landmark_list)
...
if __name__ == '__main__':
    ges_num = []
    with open('csv_file/landmark_6_9_3.csv', 'w') as f:
        f.truncate(0)
    key, _ = load_labels()
    for i in key:
        ges_num.append(i)
